    ...
    <div class="clients-section services-clients-section clients-testimonial-page overflow-hidden">
        <div class="about-right-icon position-relative">
            <figure class="whyus-icon"><img src="{{ asset('templates/my_template/assets/images/about-us-section-right-icon.png') }}" alt="" class="img-fluid">
            </figure>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                       <div class="clients-outer-box  position-relative">
                        <figure class="clients-outer-box-figure"><img src="{{ asset('templates/my_template/assets/images/client-section-img3.png') }}" alt=""></figure>
                        <figure class="position-absolute icon-figure-quotes"><img src="{{ asset('templates/my_template/assets/images/quotes-icon.png') }}" alt=""></figure>
                         <div class="clients-right-content">
                            <span class="spencer-span">Spencer Simpson</span>
                            <span class="ceo-p">CEO - Company</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="clients-outer-box  position-relative">
                            <figure class="clients-outer-box-figure"><img src="{{ asset('templates/my_template/assets/images/client-section-img4.png') }}" alt=""></figure>
                            <figure class="position-absolute icon-figure-quotes"><img src="{{ asset('templates/my_template/assets/images/quotes-icon.png') }}" alt=""></figure>
                             <div class="clients-right-content">
                                <span class="spencer-span">Spencer Simpson</span>
                                <span class="ceo-p">CEO - Company</span>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                   <div class="clients-outer-box  position-relative" data-aos="fade-up">
                    <figure class="clients-outer-box-figure"><img src="{{ asset('templates/my_template/assets/images/client-section-img5.png') }}" alt=""></figure>
                    <figure class="position-absolute icon-figure-quotes"><img src="{{ asset('templates/my_template/assets/images/quotes-icon.png') }}" alt=""></figure>
                     <div class="clients-right-content">
                        <span class="spencer-span">Spencer Simpson</span>
                        <span class="ceo-p">CEO - Company</span>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="clients-outer-box  position-relative" data-aos="fade-up">
                        <figure class="clients-outer-box-figure"><img src="{{ asset('templates/my_template/assets/images/client-section-img6.png') }}" alt=""></figure>
                        <figure class="position-absolute icon-figure-quotes"><img src="{{ asset('templates/my_template/assets/images/quotes-icon.png') }}" alt=""></figure>
                         <div class="clients-right-content">
                            <span class="spencer-span">Spencer Simpson</span>
                            <span class="ceo-p">CEO - Company</span>
            ...
            <div class="clients-section-btn">
                <a href="{{ url('/about') }}" class="text-decoration-none">View All Review</a>
            </div>
        </div>
    </div>
